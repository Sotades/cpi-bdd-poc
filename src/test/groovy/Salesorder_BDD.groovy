...
class Salesorder_BDD extends Specification {
    ...
    def "Testing to-be CPI SalesOrder Transform"() {
        ...
        //println(responseXml.IDOC.EDI_DC40.IDOCTYP)
        println(responseXml.IDOC.Z1ZALMA_SALESORDERCREATEFRO.E1BPSDHD1.DOC_TYPE.text())

        //responseXml.IDOC.E1BPSDHD1.DOC_TYPE == doc_type
        ...
        _____
        itm_number_1|material_1|target_quantity_1|itm_categ_1|prc_grp_1|prc_grp_3|order_id_1|partner_customer_number|partner_customer_name|partner_customer_name_2|partner_customer_name_3|partner_customer_name_4|partner_customer_street|partner_customer_country|partner_customer_postal_code|partner_customer_city|partner_interface_number|partner_sales_person_number|requested_quantity|pricing_condition|condition_value|item_10_text_line
        '000010'    |'1000'    |'1'              | 'ZTDC'    |'TBD'    |'TBD'    |'E9Q3X7'  |'10016734'             |'Fred Astaire'       |'Fred Kruger'          |'Fred Flintstone'     |'Fred the Shred'        |'10 Downing Street'    |'United Kingdom'        |'SW1A 2AA'                  |'London'             |'ZI_EVENT'              |"VIRVEK"                   |'1'               |'ZPR0'           |'633.0000'     |'ID: 131217, 02740, Espoo, Uusimaa, Finland: Vesimittarien vaihto, 27 kpl.* 2'
    }
